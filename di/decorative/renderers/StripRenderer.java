...
public class StripRenderer implements ISimpleBlockRenderingHandler
{
	...
	{		
		...
		TileEntityStripHazardBlock tile = (TileEntityStripHazardBlock)world_.getBlockTileEntity(x_, y_, z_);
        ...
        {       	
	       ...
	       /*
        	this.bindStripTexture(tile.getStripPosition(2));
        	tessellator.addVertexWithUV(x_, y_, z_+1 + zOffset, 0, 1);
        	tessellator.addVertexWithUV(x_+1, y_, z_+1 + zOffset, 1, 1);
        	tessellator.addVertexWithUV(x_+1, y_+1, z_+1 + zOffset, 1, 0);
        	tessellator.addVertexWithUV(x_, y_+1, z_+1 + zOffset, 0, 0);
        ...
        {   
            ...
            renderer_.clearOverrideBlockTexture();
        	/*
        	this.bindStripTexture(tile.getStripPosition(3));
        	tessellator.addVertexWithUV(x_, y_ + 1, z_ - zOffset, 0, 0);
        	tessellator.addVertexWithUV(x_ + 1, y_ + 1, z_ - zOffset, 1, 0);
        	tessellator.addVertexWithUV(x_ + 1, y_, z_ - zOffset, 1, 1);
        	tessellator.addVertexWithUV(x_, y_, z_ - zOffset, 0, 1);
        ...
        { 
            ...
            renderer_.clearOverrideBlockTexture();
        	/*
        	this.bindStripTexture(tile.getStripPosition(4));
        	tessellator.addVertexWithUV(x_ + 1 + zOffset, y_, z_ + 1, 1, 1);		//2
        	tessellator.addVertexWithUV(x_ + 1 + zOffset, y_, z_, 0, 1);			//1              
        	tessellator.addVertexWithUV(x_ + 1 + zOffset, y_ + 1, z_, 0, 0); 		//4
        	tessellator.addVertexWithUV(x_ + 1 + zOffset, y_ + 1, z_ + 1, 1, 0);	//3
        ...
        if(block_.shouldSideBeRendered(world_, x_ - 1, y_, z_, 4) == true && tile.isStripHidden(4) == false)
        {
            ...
            renderer_.clearOverrideBlockTexture();
        	/*
        	this.bindStripTexture(tile.getStripPosition(5));
        	tessellator.addVertexWithUV(x_ - zOffset, y_, z_, 0, 1);
        	tessellator.addVertexWithUV(x_ - zOffset, y_, z_ + 1, 1, 1);
        	tessellator.addVertexWithUV(x_ - zOffset, y_ + 1, z_ + 1, 1, 0);
        	tessellator.addVertexWithUV(x_ - zOffset, y_ + 1, z_, 0, 0); 
        ...
        if(block_.shouldSideBeRendered(world_, x_, y_ + 1, z_, 1) == true && tile.isStripHidden(1) == false)
        {
        	...
        	/*
        	this.bindStripTexture(tile.getStripPosition(0));
        	tessellator.addVertexWithUV(x_ + 1, y_ + 1 + zOffset, z_, 1, 1);
        	tessellator.addVertexWithUV(x_, y_ + 1 + zOffset, z_, 0, 1);
        	tessellator.addVertexWithUV(x_, y_ + 1 + zOffset, z_ + 1, 0, 0);
        	tessellator.addVertexWithUV(x_ + 1, y_ + 1 + zOffset, z_ + 1, 1, 0);
        ...
        if(block_.shouldSideBeRendered(world_, x_, y_ - 1, z_, 0) == true && tile.isStripHidden(0) == false)
        {
            ...
            renderer_.clearOverrideBlockTexture();
        	/*
        	this.bindStripTexture(tile.getStripPosition(1));
        	tessellator.addVertexWithUV(x_, y_ - zOffset, z_, 0, 1);
        	tessellator.addVertexWithUV(x_ + 1, y_ - zOffset, z_, 1, 1);
        	tessellator.addVertexWithUV(x_ + 1, y_ - zOffset, z_ + 1, 1, 0);
        	tessellator.addVertexWithUV(x_, y_ - zOffset, z_ + 1, 0, 0);
