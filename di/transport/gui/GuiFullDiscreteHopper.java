...
public class GuiFullDiscreteHopper extends GuiContainer
{
	
	private ResourceLocation texture = new ResourceLocation("discreteindustry","textures/gui/FullDiscreteHopper.png");
	//"discreteindustry","textures/blocks/emptyPlugSocket.png"
	public GuiFullDiscreteHopper(InventoryPlayer invp_, TileEntityDiscreteHopper tile_)
	{
