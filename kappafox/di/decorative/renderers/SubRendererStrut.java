...
public class SubRendererStrut extends SubBlockRenderingHandler
{
	...
	private boolean renderWorldStrut(IBlockAccess world, int x, int y, int z, Block block, TileEntitySubtype tile, RenderBlocks renderer, int subtype)
	{
        ...
        {
        	if(!this.blockEquals(id, meta, world.getBlockId(x, y, z + 1), world.getBlockMetadata(x, y, z + 1)))
        	{
        ...
        { 
        	if(!this.blockEquals(id, meta, world.getBlockId(x + 1, y, z), world.getBlockMetadata(x + 1, y, z)))
        	{
        ...
        {
        	if(!this.blockEquals(id, meta, world.getBlockId(x, y + 1, z), world.getBlockMetadata(x, y + 1, z)))
        	{
    ...
    private boolean blockEquals(int ida, int metaa, int idb, int metab)
    {
    	if(ida == idb && metaa == metab)
    	{
    		return true;
    	}
