...
public class BlockDiscreteHopper extends BlockContainer
{
	...
	public BlockDiscreteHopper(int id_, Material mat_, int rid_)
	{
		super(id_, mat_);
		this.setCreativeTab(CreativeTabs.tabAllSearch);
		this.setUnlocalizedName("discreteHopper");
    ...
    {
		TileEntityDiscreteHopper tile = (TileEntityDiscreteHopper)world_.getBlockTileEntity(xcoord_, ycoord_, zcoord_);
    ...
    public AxisAlignedBB getCollisionBoundingBoxFromPool(World world_, int x_, int y_, int z_)
    {
    	...
    	{
        	case 0:
        		return AxisAlignedBB.getAABBPool().getAABB((double)x_ + this.minX, (double)y_ + this.minY, (double)z_ + this.minZ, (double)x_ + 1.0, (double)y_ + 0.5, (double)z_ + 1.0);		
        	case 1:
        		return AxisAlignedBB.getAABBPool().getAABB((double)x_ + this.minX, (double)y_ + this.minY, (double)z_ + this.minZ, (double)x_ + 1.0, (double)y_ + 0.3, (double)z_ + 1.0);
        	case 2:
        		return AxisAlignedBB.getAABBPool().getAABB((double)x_ + this.minX, (double)y_ + this.minY, (double)z_ + this.minZ, (double)x_ + 1.0, (double)y_ + 0.1, (double)z_ + 1.0);
    	}
    	
        return AxisAlignedBB.getAABBPool().getAABB((double)x_ + this.minX, (double)y_ + this.minY, (double)z_ + this.minZ, (double)x_ + this.maxX, (double)y_ + this.maxY, (double)z_ + this.maxZ);
    }
	...
	public void getSubBlocks(int id_, CreativeTabs tabs_, List list_)
	{
		...
		list_.add(new ItemStack(id_, 1, 1));
		list_.add(new ItemStack(id_, 1, 2));
	}
	...
	*/
	...
	@Override
    public TileEntity createNewTileEntity(World world_)
    {
		/*
		TileEntityDiscreteHopper tile = new TileEntityDiscreteHopper();		
        return tile;
        */
    ...
    {
        TileEntityDiscreteHopper tileentityhopper = (TileEntityDiscreteHopper)par1World.getBlockTileEntity(par2, par3, par4);
