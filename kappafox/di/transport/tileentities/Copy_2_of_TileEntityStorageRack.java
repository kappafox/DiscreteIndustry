...
public class Copy_2_of_TileEntityStorageRack extends TileEntityDiscreteBlock implements ISidedInventory
{
	...
	public Copy_2_of_TileEntityStorageRack( )
	{
		this(1);
	}
	...
	public Copy_2_of_TileEntityStorageRack(int slots)
	{
		super();
	...
	*/
    ...
    public void readFromNBT(NBTTagCompound tag)
    {
        ...
        NBTTagList eslots = tag.getTagList("extractionSlots");
        
        for (int i = 0; i < eslots.tagCount(); ++i)
        {
            NBTTagCompound nbttagcompound1 = (NBTTagCompound)eslots.tagAt(i);
            byte b0 = nbttagcompound1.getByte("Slot");
	...
	public ItemStack decrStackSize(int slot, int count)
	{
		...
		return this.removeItemFromContainer(slot - storageUnits.length, count);
	}
