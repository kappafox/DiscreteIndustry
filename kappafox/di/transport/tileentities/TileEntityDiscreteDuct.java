...
public class TileEntityDiscreteDuct extends TileEntity
{
	...
	{	
		//North
		if(this.worldObj.getBlockTileEntity(xCoord, yCoord, zCoord + 1) instanceof TileEntityDiscreteDuct)
		{
		...
		//East
		if(this.worldObj.getBlockTileEntity(xCoord - 1, yCoord, zCoord) instanceof TileEntityDiscreteDuct)
		{
