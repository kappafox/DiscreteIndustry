        ...
        else
        {
            ...
            for (int i = 0; i < this.getSizeInventory(); ++i)
            {
                ...
                if (this.getStackInSlot(i) != null)	
                {
                    ...
                    ItemStack leftover = insertStack(iinventory, this.decrStackSize(i, TRANSFER_COUNT), Facing.oppositeSide[BlockHopper.getDirectionFromMetadata(this.getBlockMetadata())]);
